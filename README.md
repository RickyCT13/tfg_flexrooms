...
Este es el repositorio principal del proyecto de fin de grado, en el que se diseña e implementa la página web de FLEXROOMS, que tiene como objetivo dar a conocer información sobre la empresa (ficticia) y sus productos, siendo en este caso espacios de uso múltiple de diferentes tipos que alquila la empresa a los clientes.
